...
| **Test Suite** | **Core Spec** | **Production Extension** | **Materials Extension** | **Slice Extension** |**Beam Lattice Extension** |**Secure Content Extension** |**Boolean Operations** |**Displacement** |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Suite 1  | X | X |   | X |   |   |   |   |
| Suite 2  | X | X | X |   |   |   |   |   |
| Suite 3  | X |   |   |   |   |   |   |   |
...
Detailed information about the test cases can be found in the [3MF_Test_Specification_v2_4_0](test_specification/3MF_Test_Specification_v2_4_0.pdf)-document.
...
* 3MF Displacement Extension - [Version 1.0.0](https://github.com/3MFConsortium/spec_displacement/blob/master/3MF%20Displacement%20Extension.md)
